            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<i v-show="isOne" :class="{'el-icon-top':isAsc,'el-icon-bottom':isDesc}"></i></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格<i v-show="isTwo" :class="{'el-icon-top':isAsc,'el-icon-bottom':isDesc}"></i></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag){
      //flag形参：它是一个标记，代表用户点击的是综合（1）价格（2）【用户点击的时候传悌过来的】
  ...
  watch:{
    $route(newValue,oldValue){
      ...
      //再次发起ajax请求
      this.getData()
      //第一次请求完毕，应该把相应的1、2、3级分类的id置空的，让他接受下一次的相应1、2、3id
      this.searchParams.category1Id = undefined
      this.searchParams.category2Id = undefined
      this.searchParams.category3Id = undefined
    }
