        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前的路由跳转，从A路由跳转到B路由，这里再加入购物车，进行路由跳转之前，发请求
                把你购买的产品信息通过请求的形式通知服务器，服务器进行相应存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopCar() {
      ...
      //调用仓库中的addOrUpdateShopCart，这个方法有async，返回的一定是promise，有async就一定有await
      //try catch方法 成功干什么 失败干什么
      try {
        ...
        //产品信息数据比较复杂，通过会话存储（不持久化，会话结束，数据消失）
        //本地存储|会话存储，一般存储的是字符串
